...
const STA_COURSES = [
  {
    ...
    "image": null,
    "accent": "navy",
    "summary": "The management side of security work: planning a security programme, writing the post orders people actually follow, and running a shift that holds together without you standing over it.",
  ...
  },
  {
    ...
    "image": null,
    "accent": "blue",
    "summary": "Day-to-day operational control: access control that holds, patrols that find things, radio discipline, and supervising officers who are not in the room with you.",
    "description": "Security Operations and Supervision is about the shift itself. It covers access control and visitor management, patrol methods that actually detect something rather than proving attendance, communication and radio discipline, control-room routine, and the supervisory work of correcting an officer without losing them. Each module ends with a scenario you work through and submit.",
    "learningObjectives": [
  ...
  },
  {
    ...
    "image": null,
    "accent": "gold",
    "summary": "Assess a site properly: identify what is worth protecting, judge threat honestly, find the gaps, and put the cost of a countermeasure next to the cost of the loss it prevents.",
    "description": "Security Risk Management teaches the assessment discipline that sits underneath every good security decision. You learn to identify and value assets, describe threats without exaggerating them, survey a site for vulnerability, and rate risk in a way that survives challenge from a finance director. The course ends with a full written security risk assessment of a real site, which the instructor reviews.",
    "learningObjectives": [
  ...
  },
  {
    ...
    "image": null,
    "accent": "gold",
    "summary": "Retail and warehouse loss: where shrinkage actually comes from, which controls repay their cost, and how to run an apprehension without creating a bigger problem.",
    "description": "Loss Prevention and Asset Protection looks at shrinkage in retail, warehouse and distribution settings — internal theft, external theft, process failure and paperwork error — and at the controls that reduce it. It covers the legal and procedural care required around apprehension and detention in the Philippines, and the audit routine that keeps a store honest with itself.",
    "learningObjectives": [
